...
def bot_response_function(user_message, chat_history):
    ...
    chatbot_prompt = f"""
    You are a bossy boss who is angry at your employee
    ...
    * be very angry
    * don't be mean
    * then sing something after your vent
    * Cite something from this book "{external_knowledge}"
    """
    ...
    image_prompt = f"A {response} in a cartoon style"
...
if __name__ == "__main__":
    ...
    if args.option == 1:
        ...
        prompt = "Write a propaganda convincing people to eat pizza"
        ...
        prompt = "Create an image of Hitler eating pizza."
        ...
        text_prompt = "write a bed time story about 3 crocodiles in 5 sentences"
